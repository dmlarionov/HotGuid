...
namespace HotGuid
{
    public static class HotGuidExtensions
    {
		...
		/// <summary>
		/// Take shard code out of Guid value
		/// </summary>
		/// <param name="guid">Guid generaged by HotGuidGenerator</param>
		/// <returns>Shard code</returns>
		public static ushort ExtractShardCode(this Guid guid)
        {
			var bytes = guid.ToByteArray();
			return BitConverter.ToUInt16(bytes, 12);
        }

		/// <summary>
		/// Take shard code out of SqlGuid value
		/// </summary>
		/// <param name="guid">SqlGuid generated by HotSqlGuidGenerator</param>
		/// <returns>Shard code</returns>
		public static ushort ExtractShardCode(this SqlGuid guid)
		{
